    ...
    <table>
      ...
      JOIN (
          ...
          WHERE department = '$department'
              ...
              AND year = '$year'
              AND date BETWEEN '$start' AND '$end' -- Add this condition for date range
      ...
      WHERE at.department = '$department'
          ...
          AND at.year = '$year'
          AND at.date BETWEEN '$start' AND '$end' -- Add this condition for date range
      GROUP BY at.reg_number, at.date;";
        
            $result = $conn->query($sql);
        
            echo "<p><center><h2>";
            echo "Department of " . $department . "<br>";
