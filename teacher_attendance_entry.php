...
<html lang="en">
  ...
  <div class="content">
    ...
    <div class="container">
      <h2 class="mb-5">Take Attendance</h2>
        ...
        <table class="table custom-table">
          ...
          <tbody>
            <tr>
              ...
              <td>
              <select id="hour" name="hour" style="border: 1px solid rgba(0, 0, 0, 0.2); border-radius: 5px; padding: 8px; font-size: 16px;" required>
                <option value="1">1</option>
                <option value="2">2</option>
                <option value="3">3</option>
                <option value="4">4</option>
...
header("Location: teacher_attendancepanel.php");
